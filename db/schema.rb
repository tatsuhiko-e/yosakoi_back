...
ActiveRecord::Schema[7.0].define(version: 2023_06_07_111449) do
  ...
  create_table "event_participations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "event_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
